...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DLSS/DLAA settings", DisplayName = "DLAA Enabled")
	bool bDLAAEnabled;

	/** DLSS quality setting, unavailable if DLAA is enabled */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DLSS/DLAA settings", DisplayName = "DLSS Quality", meta=(EditCondition="!bDLAAEnabled"))
